...
define LINUX_FIXUP_INITRD
	...
	$(if $(BR2_TARGET_ROOTFS_INITRAMFS),
		...
		$(call KCONFIG_ENABLE_OPT,CONFIG_INITRAMFS_COMPRESSION_XZ,$(LINUX_DIR)/.config)
		$(call KCONFIG_DISABLE_OPT,CONFIG_INITRAMFS_COMPRESSION_NONE,$(LINUX_DIR)/.config)
		$(foreach opt, CONFIG_RD_GZIP CONFIG_RD_BZIP2 CONFIG_RD_LZMA CONFIG_RD_LZO CONFIG_RD_LZ4 CONFIG_RD_ZSTD,
...
define LINUX_KCONFIG_FIXUP_CMDS
	...
	$(if $(BR2_PACKAGE_EBTABLES),
		$(call KCONFIG_SET_OPT,CONFIG_BRIDGE_NF_EBTABLES,m)
		$(call KCONFIG_SET_OPT,CONFIG_BRIDGE_NETFILTER,m)
		$(call KCONFIG_SET_OPT,CONFIG_BRIDGE_EBT_BROUTE,m)
		$(call KCONFIG_SET_OPT,CONFIG_BRIDGE_EBT_T_FILTER,m))
	$(if $(BR2_PACKAGE_KEXEC),
		$(call KCONFIG_ENABLE_OPT,CONFIG_KEXEC)
		$(call KCONFIG_ENABLE_OPT,CONFIG_ATAGS_PROC))
...
# build process.
define LINUX_INSTALL_IMAGE
	$(INSTALL) -m 0644 -D $(LINUX_IMAGE_PATH) $(1)/$(notdir $(LINUX_IMAGE_NAME)$(2))
endef
endif
