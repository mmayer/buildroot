...
ifeq ($(BR2_PACKAGE_LIBCAP_DISABLE_STATIC),y)
define LIBCAP_INSTALL_TARGET_FIXUP
	$(RM) -f $(STAGING_DIR)/usr/lib/libcap.a \
		$(TARGET_DIR)/usr/lib/libcap.a
endef

LIBCAP_POST_INSTALL_TARGET_HOOKS += LIBCAP_INSTALL_TARGET_FIXUP
endif
